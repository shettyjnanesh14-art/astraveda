...
export const metadata = {
  title: 'Local Business Marketing - AstraVeda',
  description: 'Digital marketing for local shops, services, and small businesses that drives foot traffic and sales.',
};
      ...
      <Section background="white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-display font-bold text-charcoal-900 mb-6">
            Local Business <span className="gradient-text">Marketing</span>
          </h1>
          <p className="text-xl text-charcoal-600 mb-8">
            Compete with big brands on a local budget. Drive foot traffic and build community.
          </p>
