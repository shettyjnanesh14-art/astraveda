...
export const metadata = {
  title: 'Restaurant & Food Marketing - AstraVeda',
  description: 'Social media and marketing for restaurants, cafes, cloud kitchens that fills tables and drives orders.',
};
      ...
      <Section background="white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-display font-bold text-charcoal-900 mb-6">
            Restaurant & Food <span className="gradient-text">Marketing</span>
          </h1>
          <p className="text-xl text-charcoal-600 mb-8">
            Fill more tables and drive more orders with crave-worthy content.
          </p>
